...
constexpr long OFF_STUDIOHDR = 0x1eb0;                         //[Miscellaneous]->CBaseAnimating!m_pStudioHdr
 
constexpr long OFF_INPUT_SYSTEM = 0x1777a00; //[Miscellaneous] InputSystem
constexpr long OFF_MOUSE_SENSITIVITY = 0x02153b80; //mouse_sensitivity
...
constexpr long OFF_PROJECTILESCALE = 0x04ec;   //CWeaponX!m_flProjectileScale //0x04ec + 0x1978;         //projectile_gravity_scale + [WeaponSettingsMeta]base
constexpr long OFF_PROJECTILESPEED = 0x04e4;//CWeaponX!m_flProjectileSpeed//0x04e4 + 0x1978;         //projectile_launch_speed + [WeaponSettingsMeta]base
constexpr long OFF_OFFHAND_WEAPON = 0x1924;                   //m_latestNonOffhandWeapons
constexpr long OFF_WEAPON_CURRENT_ZOOM_FOV = 0x15d0 + 0x00b8;          //m_playerData + m_curZoomFOV
constexpr long OFF_WEAPON_TARGET_ZOOM_FOV = 0x15d0 + 0x00bc;           //m_playerData + m_targetZoomFOV
constexpr long OFF_WEAPON_DISCARDED = 0x1579;                 //[RecvTable.DT_WeaponX]->m_discarded
constexpr long OFF_WEAPON_AMMO = 0x1580;                 //[RecvTable.DT_WeaponX]m_ammoInClip
...
constexpr long OFF_TRAVERSAL_RELEASE_TIME = 0x2af8;		   //[RecvTable.DT_LocalPlayerExclusive]->m_traversalReleaseTime
